	...
	<div class="page-body">
		<form name='f' action="./register" method='POST'>
			<div class="container">
				...
				<p style="text-align: center;">Please fill in this form to
					create an account.</p>
				...
				<label for="add"><b>Address</b></label><br> <input type="text"
					placeholder="Enter Address" name="add" required><br> <label
					for="telNo"><b>Phone Number</b></label><br> <input type="tel"
